        ...
        <div class="side-content">
            ...
            <div class="side-menu">
                <ul>
                    ...
                    <li>
                       <a href="pre-enrolled.php" class="active">
                            ...
                            <?php while($row = mysqli_fetch_assoc($result)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="delete.php?id=<?php echo htmlspecialchars($row['student_id']); ?>" title="Delete" onclick="return confirm('Are you sure you want to delete this student?');"><span class="las la-trash"></span></a>
                                    </td>
                                </tr>
                            <?php } ?>
                            </tbody>

    ...
    <div class="container">
        ...
        <div class="action-buttons">
            <form method="post" action="undo.php">
                <input type="hidden" name="student_id" value="<?= htmlspecialchars($studentInformation['student_id']) ?>">
                <button type="submit" name="action" value="undo" onclick="return confirm('Are you sure you want to undo this enrollment?');">Undo Enrollment</button>
            </form>
        </div>
